...
$currenturl = new moodle_url('/enrol/programs/management/item_training_edit.php', ['id' => $item->id]);
...
$form = new \enrol_programs\local\form\item_training_edit(null, ['training' => $training, 'context' => $context]);
...
echo $OUTPUT->heading(get_string('updatetraining', 'enrol_programs'), 3);
