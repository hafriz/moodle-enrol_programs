...
$currenturl = new moodle_url('/enrol/programs/management/user_allocation_archive.php', ['id' => $allocation->id]);

management::setup_program_page($currenturl, $context, $program);

$form = new \enrol_programs\local\form\user_allocation_archive(null, ['allocation' => $allocation, 'user' => $user, 'context' => $context]);
