...
Feature: Program upload full tests
  ...
  Scenario: System manager can upload all programs into original categories using zipped JSON
    ...
    Then the following should exist in the "management_programs" table:
      | Program name | Category   | ID number | Description  | Courses | Allocations | Public |
      | Program 00   | System     | P00       | Test program | 5       | 0           | Yes    |
  ...
  @_file_upload
  Scenario: System manager can upload all programs into original categories using normal JSON
    Given I log in as "manager1"
    And I am on all programs management page
  ...
  Scenario: System manager can upload all programs into original categories using zipped CSV comma
    ...
    When I click on "Programs actions" "link"
    And I click on "Upload programs" "link"
    And I upload "enrol/programs/tests/fixtures/upload/programs_csv_comma.zip" file to "Files" filemanager
    And I press "Continue"
    And the following fields match these values:
      | usecategory | 1 |
    And the following should exist in the "upload_preview" table:
  ...
  Scenario: System manager can upload all programs into original categories using zipped CSV semicolon
    ...
    When I click on "Programs actions" "link"
    And I click on "Upload programs" "link"
    And I upload "enrol/programs/tests/fixtures/upload/programs_csv_semicolon.zip" file to "Files" filemanager
    And I press "Continue"
    And the following fields match these values:
      | usecategory | 1 |
    And the following should exist in the "upload_preview" table:
  ...
  Scenario: System manager can upload all programs into original categories using zipped CSV tab
    ...
    When I click on "Programs actions" "link"
    And I click on "Upload programs" "link"
    And I upload "enrol/programs/tests/fixtures/upload/programs_csv_tab.zip" file to "Files" filemanager
    And I press "Continue"
    And the following fields match these values:
      | usecategory | 1 |
    And the following should exist in the "upload_preview" table:
  ...
  @_file_upload
  Scenario: System manager can upload all programs into original categories using extracted CSV
    Given I log in as "manager1"
    And I am on all programs management page

    When I click on "Programs actions" "link"
    And I click on "Upload programs" "link"
    And I upload "enrol/programs/tests/fixtures/upload/programs.csv" file to "Files" filemanager
    And I upload "enrol/programs/tests/fixtures/upload/programs_contents.csv" file to "Files" filemanager
    And I upload "enrol/programs/tests/fixtures/upload/programs_sources.csv" file to "Files" filemanager
    And I press "Continue"
    And the following fields match these values:
      | usecategory | 1 |
    And the following should exist in the "upload_preview" table:
